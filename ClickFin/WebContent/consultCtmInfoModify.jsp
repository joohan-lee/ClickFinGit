...
<div id="container" style="width:1000px">
   ...
   <table width="70%">
       ...
       <tr>
          <th>주민번호 : </th>
          <td><input type="text" value="<%=rrn %>" name="cusMyRrn"  maxlength="6" onkeyPress="InputOnlyNumber(this);" >
          	- <input type="password" value="" name="" maxlength="7" onkeyPress="InputOnlyNumber(this);"></td>
       </tr>
       <tr>
          <th>연락처 : </th>
